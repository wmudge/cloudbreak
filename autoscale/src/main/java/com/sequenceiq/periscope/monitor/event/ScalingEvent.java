...
public class ScalingEvent extends ApplicationEvent {
    ...
    private transient Integer desiredHostGroupNodeCount;
    ...
    public Integer getDesiredHostGroupNodeCount() {
        return desiredHostGroupNodeCount;
    }

    public void setDesiredHostGroupNodeCount(Integer desiredHostGroupNodeCount) {
