...
public class ScalingHandlerTest {
    ...
    public void testOnApplicationEventWhenLoadAlertDecommissionNodes() {
        ...
        when(scalingEventMock.getDesiredHostGroupNodeCount()).thenReturn(expectedNodeCount);
    ...
    public void testOnApplicationEventWhenNoScaling() {
        ...
        when(scalingEventMock.getDesiredHostGroupNodeCount()).thenReturn(2);
    ...
    private void validateClusterScaling(BaseAlert baseAlertMock,
        ...
        when(scalingEventMock.getDesiredHostGroupNodeCount()).thenReturn(currentHostGroupCount + scalingAdjument);
